    ...
    public class CommandManager : MonoBehaviour
    {
        ...
        private void Awake()
        {
            if (instance == null)
            {
                ...
                {
                    MethodInfo extendedMethod = extension.GetMethod("Extend");
                    extendedMethod.Invoke(null, new object[] { database });
                }
            }
            else
        ...
        public CommandDatabase CreateSubDataBase(string name)
        {
            ...
            {
                Debug.LogWarning($"A database by name of '{name}' already exists!");
                return db;
            }
